...
class MediaConfig:
    def __init__(self, content_type='audio/*', layout=None, rate=None,
                 audio_format=None, channels=None, language=None):
        ...
        :param language (optional): the language to use for the streaming job
        """
    ...
    def get_content_type_string(self):
        ...
        return self.content_type + \
            ...
            (';language={}'.format(self.language) if self.language else '')
