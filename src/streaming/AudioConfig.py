...
class AudioConfig():
    def __init__(self, content_type = 'audio/*', layout = None, rate = None, audio_format = None, channels = None):
        """Constructor for AudioConfig class

        :param content_type (optional): string containing content type. Default will resort to 
